...
public class UserController {
    ...
    public String getHomePage(Model model) {
        List<User> arrUsers = this.userService.getUsersByEmail("doxuantutlbt@gmail.com");
    ...
    public String getUserPageDetail(Model model, @PathVariable("id") Long id) {
    ...
    public String createUserPage(Model model,
        ...
        String avater = this.uploadService.handleFileUpload(file, "avatar");
